...
class QuestionHandler:
    ...
    def response(self, query, doc):
        ...
        if(query == ""):
            ...
            doc_keyword_prompt = Axis_prompts.keyword_prompt(type = self.doc_type)
...
#class CV_Questions: ##CV questions
...
#        self.JD=None
#    
#    def update_variables(self,username=None,depth=None,duration=None,output=None,user_id=None,query=None):
#        if username:
#            self.username = username
#        if depth:
#            self.depth = depth
...
#        Question_Temp=f"""-You have to extract the question from the following text. Just extract the question."""
#        try:
#            print(self.prev)
#            question=CompletionGenerator.generate_chat_completion(prompt=Question_Temp,query=self.prev)
#            self.question=question
...
#    
#    def run_summary(self):
#        temp=Axis_prompts.summary_template(history,question,query,result)
#        output=CompletionGenerator.generate_completion(temp)
#        self.history=output
#        print(output)
#        return output
#    
...
#        if(query==""):
#            self.history=self.run_summary()
#            JD_keyword_prompt=Axis_prompts.keyword_prompt(type = "CV")
#            print(JD_keyword_prompt)
#            print(self.CV)
#            list_topic=CompletionGenerator.generate_chat_completion(prompt = JD_keyword_prompt,query = self.CV)
#            print(list_topic)
#            self.list_topic=list_topic
#        self.query=query
#        template=Axis_prompts.QuestionsPrompt("CV",self.list_topic, self.history)
#        # print(template)
#        output=CompletionGenerator.generate_chat_completion(prompt = template,query =query)
#        self.output=output
#        if(query!=""):
...
#        return output
#
#class JD_Questions: ##JD Questions
#    def __init__(self,username,user_id):
#        self.query =None
#        self.username = username
#        self.output=None
...
#        return output
#    
#    def response(self,query,JD):
#        self.JD=JD
#        if(query==""):
#            self.history=self.run_summary()
#            JD_keyword_prompt=Axis_prompts.keyword_prompt("Job Description")
#            list_topic=CompletionGenerator.generate_chat_completion(prompt= JD_keyword_prompt,query = self.JD)
#            print(list_topic)
#            self.list_topic=list_topic
#        self.query=query
#        template=Axis_prompts.QuestionsPrompt("Job Description")
#        # print(template)
#        output=CompletionGenerator.generate_chat_completion(prompt= template,query = query)
#        self.output=output
#        if(query!=""):
